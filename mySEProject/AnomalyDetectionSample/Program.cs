...
namespace NeoCortexApiSample
{
    ...
    public class HTMAnomalyTesting
    {
        ...
        public HTMAnomalyTesting(string trainingFolderPath = @"D:\general\ConsoleApp1\ConsoleApp1\training", string testingFolderPath = @"D:\general\ConsoleApp1\ConsoleApp1\testing")
        {
            _trainingFolderPath = trainingFolderPath;
            _testingFolderPath = testingFolderPath;
        }
